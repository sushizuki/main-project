			...
			<form role="form" action="Order?action=saveOrder" method="post">
				...
				<div class="row">
					<div class="col-md-2 col-sm-12 col-xs-12">
						<span><strong>Cliente: </strong><br> <c:out
								value="${order.client.name}" /> </span>
					</div>
					<div class="col-md-4 col-sm-12 col-xs-12">
						<span><strong>Endereço: </strong><br> <c:out
								value="${order.receiving.address}" /> </span>
					</div>
				</div>
				<div class="row">
					<div class="col-md-2 col-sm-6 col-xs-6">
						<span><strong>Horário:</strong> <br> <fmt:formatDate
								type="both" pattern="dd/MM/yyyy HH:mm"
								value="${order.receiving.time.time}" /> </span>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-6">
						<span><strong>Pagamento: </strong><br> <c:out
								value="${order.payment.paymentType}" /><br> <c:if
								test="${order.payment.change != null}">
	                	 					Troco para: <fmt:formatNumber
