	...
	<body>
		...
		<div class="eshop-section section">
			<div class="container">
					...
					<form action="Order?action=newOrder" method="post">
								...
								<div class="col-md-3 col-sm-4">
									<div class="shop-item">
										...
										<div class="actions">
											...
											<br /><br />
											<div id="product-qtd-div-${product.id }" style="visibility:hidden;">
						...
						<div class="row-fluid">
							<div class="text-center col-md-12 col-sm-12 col-xs-12">
								<button type="SUBMIT" class="btn btn-primary btn-lg" style="font-variant: small-caps; font-size:13pt;" disabled>
				...
				</div> <!-- End all items Menu -->				
			</div> <!-- End container -->
		</div> <!-- End e-shop section -->
