...
public abstract class Validation {
	 ...
	 */
	protected static boolean isNotEmpty(final String string){
	 ...
	 */
	protected static boolean containsOnlyNumbers(String string){
	 ...
	 */
	protected static boolean containsOnlyLetters(final String string){
	 ...
	 */
	protected static boolean containsOnlyLettersAndSpaces(final String string){
